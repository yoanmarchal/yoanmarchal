...
| [villagecraft](https://github.com/yoanmarchal/villagecraft) | — | `TypeScript` | 0 | today |
| [v-invoice](https://github.com/yoanmarchal/v-invoice) | WIP | `JavaScript` | 0 | yesterday |
<!-- RECENT_PROJECTS:END -->

<sub>Automatically updated · <!-- LAST_UPDATE:START -->September 25, 2026<!-- LAST_UPDATE:END --></sub>
